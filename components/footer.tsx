    ...
    >
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          {/* PRODUCTS - Centered Heading with Two Columns */}
          <div>
            <h3
              className={`text-sm font-semibold mb-6 uppercase tracking-wider text-center ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-xs mb-4">
                Regulatory Credentials: NSE: AP0297130541 | BSE: AP01044601140 |
                MCX: MCX/AP/151388 | AMFI: ARN-175170 | LIC Code: 07980346
              </p>
            </div>
