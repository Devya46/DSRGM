  ...
  tools: [
    {
      ...
      description:
        "Calculate potential returns from your investments based on different parameters.",
    ...
    },
    {
      ...
      description:
        "Analyze your existing portfolio for diversification, risk, and potential optimization opportunities.",
    ...
    },
    {
      ...
      description:
        "Plan your systematic investment plan and visualize the growth over time.",
      category: "Calculators",
    ...
    },
    {
      ...
      title: "Goal Planner",
      description:
        "Set financial goals and create an investment roadmap to achieve them.",
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="relative py-16 px-8 sm:px-16 bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-xl text-gray-600 dark:text-gray-300 mb-8">
                ...
                expert-led courses, and practical tools designed to make you a
        ...
        <section
          className={`transition-all duration-300 ease-in-out overflow-hidden mb-12 ${showFilters ? "max-h-96" : "max-h-0"}`}
        >
          ...
          <section key={resourceType} className="mb-16">
            ...
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center">
                ...
                {resourceType === "videos" && (
                  <PlayIcon className="h-6 w-6 mr-2 text-indigo-600 dark:text-indigo-400" />
                )}
                {resourceType === "articles" && (
                  <BookOpenIcon className="h-6 w-6 mr-2 text-indigo-600 dark:text-indigo-400" />
                )}
                {resourceType === "tools" && (
            ...
            <div className="px-8 py-12 sm:px-12 sm:py-14 lg:flex lg:items-center lg:justify-between relative">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-lg text-indigo-100 max-w-lg">
                  Try our personalized learning paths designed for investors at
                  all stages, from beginners to seasoned professionals.
                </p>
              </div>
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="px-6 py-5">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-300">
                  Most of our articles and basic videos are free for all users.
                  Premium courses and advanced tools require a subscription or
                  can be accessed by our investment clients.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="px-6 py-5">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-300">
                  Yes, most of our articles and course materials can be
                  downloaded as PDFs for offline reading. Videos are available
                  for offline viewing in our mobile app.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="px-6 py-5">
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-300">
                  We add new content weekly, including articles, videos, and
                  tools. Major course updates are released quarterly.
                </p>
              </div>
            </div>
