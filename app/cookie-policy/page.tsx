      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            This Cookie Policy explains how DSR GROUP MANDSAUR uses cookies and
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 sm:p-8">
              <section id="introduction" className="mb-12">
                ...
                <div className="prose dark:prose-invert max-w-none">
                  <p>
                    This Cookie Policy explains how DSR GROUP MANDSAUR ("we",
                    "us", or "our") uses cookies and similar technologies to
                    recognize you when you visit our website at{" "}
                    <a
                      href="https://www.dsrgroupmandsaur.com"
                      className="text-indigo-600 dark:text-indigo-400 hover:underline"
                    >
                      www.dsrgroupmandsaur.com
                    </a>{" "}
                  ...
                  <p>
                    ...
                    information, or information that becomes personal
                    information if we combine it with other data. In such cases,
                    our Privacy Policy will apply in addition to this Cookie
                    Policy.
                  </p>
                </div>
              </section>
              ...
              <section id="what-are-cookies" className="mb-12">
                ...
                <div className="prose dark:prose-invert max-w-none">
                  ...
                  <p>
                    Cookies set by the website owner (in this case, DSR GROUP
                    MANDSAUR) are called "first-party cookies". Cookies set by
                  ...
                  <div className="mt-6 space-y-6">
                    <div>
                      ...
                      <ul className="mt-2 list-disc pl-5 space-y-2">
                        <li>
                          To enable you to log in and access secure areas of our
                          Website
                        </li>
                        <li>To remember your preferences and settings</li>
                        <li>
                          To analyze how our Website is used and improve its
                          performance
                        </li>
                        <li>
                        ...
                        <li>
                          To personalize content and remember your site
                          preferences
                        </li>
                        <li>
                          To show you relevant advertising on and off our
                          Website
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-sm">
                          ...
                          Facebook, Twitter, and LinkedIn buttons. These
                          features may collect your IP address, which page you
                          are visiting on our Website, and may set a cookie to
              ...
              <section id="contact" className="mb-6">
                ...
                <div className="prose dark:prose-invert max-w-none">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg mt-4">
                    <p className="mb-1">
                      <strong>DSR GROUP MANDSAUR</strong>
                    </p>
                    <p className="mb-1">
                      Address: DSR GROUP MANDSAUR, 117 Nemi Nagar Kothari
                      Colony, Street No 3 (Motilal Oswal Financial Services),
