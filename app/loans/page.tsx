...
export default function LoansPage() {
  ...
  const loanTypes = [
    {
      ...
      description:
        "Quick access to funds for any personal need without collateral. Ideal for emergencies, travel, or consolidating debt.",
    },
    {
      id: "home",
      name: "Home Loan",
      ...
      description:
        "Finance your dream home with competitive interest rates and flexible repayment options. Tax benefits available under Section 24 and 80C.",
    },
    {
      id: "car",
      name: "Car Loan",
      ...
      description:
        "Drive home your dream car with quick loan approval and minimal documentation. Options for both new and pre-owned vehicles.",
    },
    {
      id: "education",
      name: "Education Loan",
      ...
      description:
        "Invest in your future with loans for higher education in India or abroad. Interest subsidy available for eligible students.",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Generally, you need identity proof (Aadhar, PAN), address proof, income proof (salary slips or ITR), and bank statements for the last 6 months. Specific loan types may require additional documents like property papers for home loans or admission letter for education loans.",
    },
    {
      question: "How is my loan eligibility determined?",
      answer:
        "Loan eligibility depends on factors like your income, existing financial obligations, credit score, age, and employment stability. Lenders typically consider your debt-to-income ratio to ensure you can comfortably repay the loan.",
    },
    {
      question: "Can I repay my loan before the tenure ends?",
      answer:
        "Yes, most loans can be repaid before the full tenure through partial or full prepayment. However, some lenders may charge a prepayment penalty, typically ranging from 2-5% of the outstanding amount.",
    },
    {
      question: "How long does the loan approval process take?",
      answer:
        "The approval timeline varies by loan type and lender. Personal loans may be approved within 24-48 hours, while home loans can take 7-15 days due to additional verification steps like property evaluation.",
    },
    {
      question: "What happens if I miss an EMI payment?",
      answer:
        "Missing an EMI payment can result in late payment fees, negatively impact your credit score, and potentially lead to higher interest rates on future loans. Repeated defaults may result in recovery proceedings as per the loan agreement.",
    },
  ];
  ...
  return (
    <div
      className={`min-h-screen ${theme === "light" ? "bg-gray-50 text-gray-900" : "bg-gray-900 text-gray-100"}`}
    >
      <NavBar />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              ...
              <p className="text-lg mb-8 text-gray-600 dark:text-gray-300">
                Achieve your financial goals with our range of competitive loan
                products. Fast approvals, minimal paperwork, and dedicated
            ...
            <div
              className={`lg:w-1/2 rounded-xl p-6 shadow-lg ${
                ...
                >
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        {formatCurrency(calculateTotalPayment().totalInterest)}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-medium">
                        {formatCurrency(calculateTotalPayment().totalPayment)}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Choose from our range of loan options designed to meet your
      ...
      <section
        className={`py-16 px-4 ${theme === "light" ? "bg-gray-900 text-white" : "bg-gray-950 text-white"}`}
      >
        <div className="container mx-auto">
          <div className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-12 relative">
            {/* Process Step Lines */}
            <div
              className="hidden md:block absolute top-20 left-0 right-0 h-0.5 bg-gray-700 z-0"
              style={{ width: "75%", margin: "0 auto", top: "30" }}
            ></div>
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-gray-300">
                Receive loan approval and review the offered terms and
                conditions.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Fast application processing with minimal waiting time. Get funds
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Choose repayment options that suit your financial situation with
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Streamlined paperwork with digital KYC options to save your time
                and effort.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Complete transparency with all fees and charges clearly
                disclosed upfront.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Manage your loan, track payments, and access statements through
      ...
      {/* Call-to-Action */}
      <section
        className={`py-16 px-4 ${theme === "light" ? "bg-blue-600 text-white" : "bg-blue-900 text-white"}`}
      >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
          ...
          >
            ...
            <div className="mb-6">
              ...
              <div
                className={`w-16 h-1 mb-6 ${theme === "light" ? "bg-blue-600" : "bg-blue-500"}`}
              ></div>
            </div>

            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Applying for a loan with DSR Group is a straightforward process
              designed to get you the funds you need with minimal hassle. Our
              team of financial experts will guide you through each step.
            </p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Gather your identity proof, address proof, income documents,
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Contact our team to discuss your loan requirements and
                    receive personalized guidance on the best options.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Complete the application form with your personal,
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Our team will verify your documents, check your credit
                    score, and determine your eligibility.
                  </p>
                </div>
              </div>
            </div>
