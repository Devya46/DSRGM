...
const glossaryTerms = {
  ...
  P: [
    ...
    {
      term: "PMS (Portfolio Management Service)",
      definition:
  ...
  Q: [
    {
      term: "Quantum",
      definition: "The amount or quantity of a security or financial asset.",
    },
    {
      term: "Quote",
      definition: "The most recent price at which a security has traded.",
    },
    {
      term: "Quick Ratio",
      definition:
  ...
  S: [
    ...
    {
      term: "Small Cap",
      definition: "A company with a market capitalization below ₹5,000 crores.",
    },
    {
      term: "Sector Fund",
      definition:
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Your comprehensive guide to financial and investment terms.
            Understanding these terms will help you make more informed decisions
        ...
        <div className="flex justify-center flex-wrap max-w-4xl mx-auto mb-12 sticky top-0 bg-gray-50 dark:bg-gray-900 py-4 z-10 border-b border-gray-200 dark:border-gray-700">
          {alphabetLetters.map((letter: string) => (
            <button
              key={letter}
        ...
        <div className="space-y-16">
          {Object.keys(filteredTerms).map((letter: string) => (
            <div key={letter} id={`letter-${letter}`} className="scroll-mt-24">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {filteredTerms[letter as keyof typeof filteredTerms].map(
                  (
