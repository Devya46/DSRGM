...
const digestArticles = [
  {
    ...
    excerpt:
      "A comprehensive analysis of market trends, performance metrics, and strategic outlook for the coming quarter.",
    category: "Market Analysis",
    date: "May 15, 2026",
    readTime: "8 min read",
    image: "/Quarterly-Market-Review.png",
    featured: false,
  },
  {
    id: 2,
    ...
    excerpt:
      "Learn the fundamentals of mutual funds, how they work, and why they might be a good addition to your investment portfolio.",
    category: "Investment Education",
    date: "April 28, 2026",
    readTime: "6 min read",
    image: "/Understanding Mutual Funds.png",
    featured: false,
  },
  {
    id: 5,
    ...
    excerpt:
      "Analysis of how international economic and political developments affect domestic market performance.",
    category: "Market Analysis",
    date: "March 15, 2026",
    readTime: "10 min read",
    image: "/The Impact of Global Events on Indian Markets.png",
    featured: false,
  },
  {
    id: 6,
    ...
    excerpt:
      "How technology is reshaping the landscape of financial services and what it means for investors.",
    category: "Industry Trends",
    date: "February 28, 2026",
    readTime: "5 min read",
    image: "/Digital Transformation in Financial Services.png",
    featured: false,
  },
  {
    id: 7,
    ...
    excerpt:
      "The importance of early retirement planning and strategies to ensure financial security in your golden years.",
  ...
  },
  {
    ...
    excerpt:
      "A detailed guide on Initial Public Offerings, their evaluation, and considerations before investing.",
    category: "Investment Education",
    date: "January 30, 2026",
    readTime: "8 min read",
    image: "/IPO RISK AND OPPOURTUNITY.png",
    featured: false,
  },
];
...
export default function DSRGroupDigestPage() {
  ...
  const [featuredArticle, setFeaturedArticle] = useState(
    digestArticles.find((article) => article.featured),
  );
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Stay informed with our latest insights, market analysis, and
            investment strategies to help you make sound financial decisions.
          </p>
        </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
              <div className="md:flex">
                ...
                <div className="p-8 md:w-1/2">
                  ...
                  <Link
                    href={`/dsr-group-digest/${featuredArticle.slug}`}
                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      ...
                      <Link
                        href={`/dsr-group-digest/${article.slug}`}
                        className="text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 font-medium text-sm flex items-center"
                      >
                        Read More
        ...
        {/* Contact Us Section - Replaces Newsletter */}
        <section className="mb-16">
          <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 dark:from-indigo-800 dark:to-indigo-900 rounded-xl shadow-lg overflow-hidden">
            <div className="px-6 py-10 sm:px-10 sm:py-12 lg:flex lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-2 text-lg text-indigo-100">
                  ...
                  inquiries, suggestions, or assistance.
                </p>
              </div>
              <div className="mt-8 lg:mt-0 lg:ml-8">
                <Link
                  href="/contact"
                  className="w-full flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200"
                >
