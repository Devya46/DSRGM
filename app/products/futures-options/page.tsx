  ...
  return (
    ...
    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div>
              ...
              <p className="text-lg mb-8 leading-relaxed">
                Enhance your trading strategy with derivatives. Futures and
                options provide leverage, hedging capabilities, and trading
      ...
      <section id="fo-basics" className="py-16 px-4">
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mb-12">
              <h3
                className={`text-2xl font-semibold mb-6 ${theme === "light" ? "text-gray-800" : "text-white"}`}
              >
                Futures Contracts
              </h3>
              <p className="mb-6 text-lg leading-relaxed">
                A futures contract is an agreement to buy or sell an underlying
                asset at a predetermined price at a specified time in the
                future. Both the buyer and seller are obligated to fulfill the
              ...
              >
                <h4
                  className={`text-xl font-semibold mb-4 ${theme === "light" ? "text-blue-700" : "text-blue-400"}`}
                >
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <div>
                      <span className="font-semibold">Leverage:</span> Control a
                      large position with a relatively small amount of capital
                    </div>
                  </li>
                  <li className="flex items-start">
                    <div className="min-w-[8px] h-2 rounded-full bg-blue-500 mt-2.5 mr-3"></div>
                    <div>
                      <span className="font-semibold">Obligation:</span> Both
                      parties must fulfill the contract at expiration
                    </div>
                  </li>
                  <li className="flex items-start">
                    <div className="min-w-[8px] h-2 rounded-full bg-blue-500 mt-2.5 mr-3"></div>
                    <div>
                      <span className="font-semibold">Margin:</span> Initial and
                      maintenance margins are required
                    </div>
                  </li>
                  <li className="flex items-start">
                    <div className="min-w-[8px] h-2 rounded-full bg-blue-500 mt-2.5 mr-3"></div>
                    <div>
                      <span className="font-semibold">Settlement:</span> Can be
                  ...
                  <li className="flex items-start">
                    <div className="min-w-[8px] h-2 rounded-full bg-blue-500 mt-2.5 mr-3"></div>
                    <div>
                      <span className="font-semibold">Expiry:</span> Monthly or
            ...
            <div className="pt-6">
              {" "}
              {/* Added padding-top for better separation */}
              <div className="flex items-center mb-6">
                ...
                <h3
                  className={`text-2xl font-semibold ${theme === "light" ? "text-gray-800" : "text-white"}`}
                >
                  Options Contracts
                </h3>
              </div>
              <p className="mb-6 text-lg leading-relaxed">
                Options give the buyer the right, but not the obligation, to buy
                (call option) or sell (put option) an underlying asset at a
                specified price (strike price) before or on the expiration date.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                ...
                >
                  <h4
                    className={`text-lg font-semibold mb-3 ${theme === "light" ? "text-purple-700" : "text-purple-400"}`}
                  >
                    Call Options
                  </h4>
                  <p>
                    Right to buy the underlying asset at the strike price.
                    Profitable when prices rise above the strike price plus
                    premium.
                  </p>
                </div>
                <div
                ...
                >
                  ...
                  <p>
                    ...
                    Profitable when prices fall below the strike price minus
                    premium.
                  </p>
                </div>
              </div>
              ...
              >
                <h4
                  className={`text-xl font-semibold mb-4 ${theme === "light" ? "text-indigo-700" : "text-indigo-400"}`}
                >
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <div>
                      <span className="font-semibold">Premium:</span> Price paid
                      by the buyer to the seller for the option contract
                    </div>
                  </li>
                  <li className="flex items-start">
                    <div className="min-w-[8px] h-2 rounded-full bg-indigo-500 mt-2.5 mr-3"></div>
                    <div>
                      <span className="font-semibold">Strike Price:</span> The
                      price at which the underlying can be bought (call) or sold
                      (put)
                    </div>
                  </li>
                  <li className="flex items-start">
                    <div className="min-w-[8px] h-2 rounded-full bg-indigo-500 mt-2.5 mr-3"></div>
                    <div>
                      <span className="font-semibold">Expiration:</span> Date
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      Relation between current market price and strike price
                    </div>
                  </li>
                </ul>
              </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <h2
            className={`text-3xl font-bold mb-8 text-center ${theme === "light" ? "text-gray-900" : "text-white"}`}
          >
            Popular F&O Trading Strategies
          </h2>
          <p className="text-center mb-12 max-w-3xl mx-auto">
            Discover effective futures and options strategies used by traders to
            generate income, protect existing positions, or speculate on market
            movements.
          </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                >
                  <div className="h-full flex items-center justify-center p-10">
                    <Image
                      src="/Quarterly Market Review.png"
                      width={590}
                      height={590}
      ...
      >
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg md:text-xl mb-10 max-w-3xl mx-auto">
            Start trading futures and options with DSR Group today. Get access
            to professional tools, expert research, and ultra-low brokerage
            rates to maximize your trading potential.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="/open-account"
              className="py-3 px-8 rounded-lg font-medium transition-all bg-white text-indigo-700 hover:bg-gray-100"
            >
              Open F&O Trading Account
            </Link>
            <Link
              href="/contact"
              className="py-3 px-8 rounded-lg font-medium transition-all bg-transparent text-white border border-white hover:bg-white/10"
            >
